...
- Added a migration to reduce hourly trend collection to the three countries exposed by the app—Korea, the United States, and Japan—by unscheduling the legacy Brazil and Indonesia Cron jobs without deleting their existing trend data. Production application is waiting for the resource-exhausted database to accept connections again.
