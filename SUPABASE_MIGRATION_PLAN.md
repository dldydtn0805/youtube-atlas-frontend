...
| P1       | YouTube liked-video chart                                   | Done: channel favorites are removed and the personal chart reads the signed-in YouTube account's real liked videos with pagination and contextual OAuth                                                                                |
