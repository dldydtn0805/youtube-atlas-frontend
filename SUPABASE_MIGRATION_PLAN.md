...
| P0       | Scheduled trending sync and retention                       | Target: five Cron jobs cover three hourly country syncs, five-minute settlement, and daily retention within the free-plan limits                                                                                            |
| P0       | Three-country trend-sync load                                | Ready: migration keeps only app-visible KR, US, and JP hourly collection without deleting historical rows; production application awaits database connection recovery                                                       |
...
35. Added migration `20260802020000` to unschedule Brazil and Indonesia trend collection while retaining hourly Korea, United States, and Japan syncs, five-minute game settlement, daily retention, and all existing trend rows. Production application is pending because the resource-exhausted database timed out both CLI and dashboard connections.
