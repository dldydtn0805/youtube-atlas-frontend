...
| P1       | Single-name home branding                                   | Done: the two-line legacy header is replaced by a responsive pixel-art sidearm that acts as the T in The Rank Game, with matching accessible navigation text                                                                |
