...
describe('GameSeasonCountdown', () => {
  it('formats the remaining season time with the end date', () => {
    ...
    expect(formatSeasonTimeLeft('2026-08-01T05:10:09.000Z', nowMs, '2026-04-01T00:00:00.000Z')).toBe(
      '4개월 시즌 종료까지 2933시간 10분 9 초 남음',
    );
    expect(formatSeasonTimeLeft('2026-08-01T00:00:30.000Z', nowMs, '2026-04-01T00:00:00.000Z')).toBe(
      '4개월 시즌 종료까지 2928시간 0분 30 초 남음',
    );
    expect(formatSeasonTimeLeft('2026-08-01T00:00:30.000Z', nowMs, '2026-04-01T00:00:00.000Z')).toBe(
      '4개월 시즌 종료까지 2928시간 0분 30 초 남음',
    );
  ...
  it('shows that the season has ended after the end time', () => {
    ...
    expect(formatSeasonTimeLeft('2026-08-01T00:00:00.000Z', nowMs, '2026-04-01T00:00:00.000Z')).toBe(
      '4개월 시즌 종료',
    );
  });
