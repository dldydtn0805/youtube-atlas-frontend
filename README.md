...
- Top 200 코인 채굴 구간 기준 예상 코인 채굴 미리보기
- 코인 표 모달에서 1위 3.0%부터 200위 0.03%까지 순위별 코인 채굴률 확인
...
6. 채팅은 전역 채팅방 하나로 운영되며, `/ws` 구독을 통해 새 메시지를 반영합니다.
